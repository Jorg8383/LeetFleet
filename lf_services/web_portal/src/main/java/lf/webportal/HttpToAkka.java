...
public class HttpToAkka extends AllDirectives implements WebPortalInterface {
  ...
  private CompletionStage<WebPortalInterface.FirstMessageToWebPortal> tomsTestMethod() {
