...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        log.info("Creating GirlPower Quotation Service Actor...");

        // Create a quotation service actor...
        ActorRef gpQuoterRef = system.actorOf(Props.create(Quoter.class), "girlpower");
        // .. and initialise it by sending it a message with an instance of our GPQService
        gpQuoterRef.tell(new InitQuotationService(new GPQService()), null);
        ...
        selection.tell("register", gpQuoterRef);
    }
}
