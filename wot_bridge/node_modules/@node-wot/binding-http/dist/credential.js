...
class TuyaCustomBearer extends Credential {
    ...
    sign(request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new node_fetch_1.Request(url, { method: request.method, body: body !== "" ? body : null, headers: headers });
        });
    }
    ...
    requestSign(NormalRequest, requestTime, body, headers, path, method) {
