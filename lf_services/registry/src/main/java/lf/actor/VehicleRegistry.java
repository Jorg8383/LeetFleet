...
public class VehicleRegistry extends AbstractBehavior<VehicleRegistry.Command>  {
    ...
    interface Command {}  // this is really just a 'label' so...
    ...
    private VehicleRegistry(ActorContext<Command> context) {
      super(context);
    }

    public static Behavior<Command> create() {
      return Behaviors.setup(VehicleRegistry::new);
    }
